...
if __name__ == '__main__':
    ...
    if not os.path.exists(os.path.join(root_path, 'smoke_coco/annotations')):
        os.makedirs(os.path.join(root_path, 'smoke_coco/annotations'))
    if not os.path.exists(os.path.join(root_path, 'smoke_coco/train2017')):
        os.makedirs(os.path.join(root_path, 'smoke_coco/train2017'))
    if not os.path.exists(os.path.join(root_path, 'smoke_coco/val2017')):
        os.makedirs(os.path.join(root_path, 'smoke_coco/val2017'))
    xml_dir = os.path.join(root_path, 'VOC2012/Annotations')  # 已知的VOC2012的标注
    ...
    json_file = os.path.join(root_path, 'smoke_coco/annotations/detections_val2017.json')
    convert(xml_list, xml_dir, json_file)
    for xml_file in xml_list:
        img_name = xml_file[:-4] + '.png'
        shutil.copy(os.path.join(root_path, 'VOC2012/JPEGImages', img_name),
                    os.path.join(root_path, 'smoke_coco/val2017', img_name))
    # train data
    ...
    for xml_file in xml_list:
        img_name = xml_file[:-4] + '.png'
        shutil.copy(os.path.join(root_path, 'VOC2012/JPEGImages', img_name),
                    os.path.join(root_path, 'smoke_coco/train2017', img_name))
